...
using EnterpriseBotLab.Dialogs.Main;

namespace EnterpriseBotLab
{
    /// <summary>
    /// Main entry point and orchestration for bot.
    /// </summary>
    public class EnterpriseBotLab : IBot
    {
        ...
        public EnterpriseBotLab(BotServices botServices, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient)
        {
            ...
            _dialogs = new DialogSet(_conversationState.CreateProperty<DialogState>(nameof(EnterpriseBotLab)));
