...
using System;
using System.Linq;
using EnterpriseBotLab.Dialogs.Main.Resources;
using EnterpriseBotLab.Middleware;
using EnterpriseBotLab.Middleware.Telemetry;
...
namespace EnterpriseBotLab
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddBot<EnterpriseBotLab>(options =>
            {
                // Load the connected services from .bot file.
